package com.hexdo.hexexamples.adapter;
...
import app.newbee.lib.util.ScreenUtils;
...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    private void runEnterAnimation(final FeedAdapter.CellFeedViewHolder holder) {
        final int screenHeight = ScreenUtils.getScreenHeigh(holder.itemView.getContext());
