...
import com.hexdo.hexexamples.adapter.UserProfileAdapter;
import com.hexdo.hexexamples.utils.CircleTransformation;
import com.hexdo.hexexamples.view.RevealBackgroundView;
...
public class UserProfileActivity extends BaseDrawerActivity implements RevealBackgroundView.OnStateChangeListener {
    ...
    @Bind(R.id.rvUserProfile) RecyclerView rvUserProfile;
    @Bind(R.id.tlUserProfileTabs) TabLayout tlUserProfileTabs;
    @Bind(R.id.ivUserProfilePhoto) ImageView ivUserProfilePhoto;
    @Bind(R.id.vUserDetails) View vUserDetails;
    @Bind(R.id.btnFollow) Button btnFollow;
    @Bind(R.id.vUserStats) View vUserStats;
    @Bind(R.id.vUserProfileRoot) View vUserProfileRoot;
    ...
    private void setupTabs() {
        ...
        tlUserProfileTabs.addTab(tlUserProfileTabs.newTab().setIcon(R.mipmap.ic_list_white));
        tlUserProfileTabs.addTab(tlUserProfileTabs.newTab().setIcon(R.mipmap.ic_place_white));
        tlUserProfileTabs.addTab(tlUserProfileTabs.newTab().setIcon(R.mipmap.ic_label_white));
    }
